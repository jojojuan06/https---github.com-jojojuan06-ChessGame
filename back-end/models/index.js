...
.then( async ()=> {
    console.info('\u001b[' + 32 + 'm' + '|---------connexion réussie à la base de donnée----------|' + '\u001b[0m'); //log vert
    ...
    console.info('\u001b[' + 32 + 'm' + '|------synchronisation réussie------|' + '\u001b[0m'); //log vert
}) .catch((error) => {
  console.info('\u001b[' + 31 + 'm' + `|------synchronisation échouée: info--->  ${error}` + '\u001b[0m');  //log rouge
